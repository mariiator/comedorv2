<?php
require_once $_SERVER['DOCUMENT_ROOT']."/comedorv2/admin/modelo/modelo_show.php";
...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
	if(isset($_POST['Edit'])){//SI DAMOS AL BOTON EDIT NOS REDIRIGIRA AL CONTROLADOR EDIT
...
require_once $_SERVER['DOCUMENT_ROOT']."/comedorv2/admin/vista/vista_show - copia.php";
?>