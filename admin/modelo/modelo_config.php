...
function mostrarTabla($cookie,$array){
	$tabla = "";
	if($cookie == "Etapas"){
		$tabla .= "<h1>Listado de Etapas</h1><table class='table table-striped'><thead class='bg-light sticky-top top-0'><tr><th>Id</th><th>Nombre</th><th>Acciones</th></tr></thead><tbody>";
		...
		$tabla .= "<h1>Listado de Clases</h1><table class='table table-striped'><thead class='bg-light sticky-top top-0'><tr><th>Id</th><th>Nombre</th><th>Acciones</th></tr></thead><tbody>";
		foreach($array as $id => $valor){
		...
		$tabla .= "<h1>Listado de Alumnos</h1><table class='table table-striped'><thead class='bg-light sticky-top top-0'><tr><th>Id</th><th>Nombre</th><th>Apellido 1</th><th>Apellido 2</th><th>Acciones</th></tr></thead><tbody>";
		foreach($array as $id => $valor){
		...
		$tabla .= "<h1>Listado de Profesores</h1><table class='table table-striped'><thead class='bg-light sticky-top top-0'><tr><th>Correo</th><th>Nombre</th><th>Apellido 1</th><th>Apellido 2</th><th>Acciones</th></tr></thead><tbody>";
		foreach($array as $id => $valor){
