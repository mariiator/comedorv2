<html>
	...
	<style>
		...
		body{
		    background-image: url('/comedorv2/css/fondo_administrador.jpg');
        ...
        <div class="collapse navbar-collapse" id="navbarScroll">
          ...
          <div class="container d-flex justify-content-center align-items-center" style="min-height: 50vh;">
			...
			<?php
				echo $tabla;
			?>
		<input type="submit" value="Editar" name="Edit" class="btn btn-warning btn-lg" />
		<input type="submit" value="Borrar" name="Delete" class="btn btn-danger btn-lg" />
    <a href="../mejora/controlador_config%20-%20copia.php" class="btn btn-success btn-lg">Volver</a>
		</form>
	</body>
</html>