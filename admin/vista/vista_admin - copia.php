      ...
      <div class="row">
        <div class="col-md-6 mb-4">
          <div class="dropdown d-grid">
            <button class="btn btn-primary btn-lg dropdown-toggle p-4" type="button" id="configuracionDropdown" data-bs-toggle="dropdown" aria-expanded="false">Configuracion</button>
        ...
        <div class="col-md-6 mb-4">
          <div class="dropdown d-grid">
            <button class="btn btn-success btn-lg dropdown-toggle p-4" type="button" id="listadoDropdown" data-bs-toggle="dropdown" aria-expanded="false">Listado</button>
        ...
        <div class="col-md-6 mb-4">
          <form method='post' action=''>
            <input type="submit" name="altas/bajas" value="Alta / Baja" class="btn btn-warning btn-lg w-100 p-4" />
          </form>
        </div>
        
        <div class="col-md-6 mb-4">
          <form method="post" action="">
            <input type="submit" name="Cerrar" value="Cerrar Sesion" class="btn btn-danger btn-lg w-100 p-4" />
          </form>
        </div>
