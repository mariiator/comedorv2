...
<body>
    <div class="container ">
		<form action="" method="post" class="card-body">
			...
			<input type="submit" value="Cerrar" name="logout" class="btn btn-warning btn-lg" />
			<a href="<?php echo $pdfAlumnos; ?>" class="btn btn-primary btn-lg" target="_blank" id="pdfAlumno">Alumnos</a>
			<a href="<?php echo $pdfProfesor; ?>" class="btn btn-primary btn-lg" target="_blank" id="pdfProfesor">Profesor</a>
			<input type="submit" name="alergias" value="Añadir Alergias / Intolerancias" class="btn btn-success btn-lg" />
		</form>
	</div>
</body>
</html>