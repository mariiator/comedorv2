<?php
require_once $_SERVER['DOCUMENT_ROOT']."/user/modelo/modelo_asistencia.php";
...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
	...
	if(isset($_POST['Volver'])){
		...
		header('location:/user/controlador/controlador_tablas.php');
		exit();
...
require_once $_SERVER['DOCUMENT_ROOT']."/user/vista/vista_asistencias.php";
?>
