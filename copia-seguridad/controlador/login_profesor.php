...
$client_id = "a0993d3a-6271-482a-9e95-f711a3570c2d";  //Application (client) ID
$ad_tenant = "13a974b4-9002-44cf-97b2-1d3b252ae820";  //Azure Active Directory Tenant ID, with Multitenant apps you can use "common" as Tenant ID, but using specific endpoint is recommended when possible
$client_secret = "3d5b3fc3-3881-4954-b29e-b01c987a082e";  //Client Secret, remember that this expires someday unless you haven't set it not to do so
$redirect_uri = "https://comedor.maristaschamberi/profesor/controlador/controlador_profesor.php";  //This needs to match 100% what is set in Azure
