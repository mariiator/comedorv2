...
function mostrarTabla($cookie,$array){
	...
	if(!empty($array)){
		if($cookie == "Etapas"){ //SI LA COOKIE ES IGUAL A ETAPAS MOSTRARA LA SIGUIENTE TABLA
			...
			$tabla .= "</tbody></table><input type='submit' value='Volver' name='Volver' class='btn btn-success btn-lg' /><input type='submit' value='Update' name='Update' class='btn btn-warning btn-lg' /><input type='submit' value='Delete' name='Delete' class='btn btn-danger btn-lg' />";
			...
			$tabla .= "</select></td></tr></tbody></table><input type='submit' value='Volver' name='Volver' class='btn btn-success btn-lg' /><input type='submit' value='Update' name='Update' class='btn btn-warning btn-lg' /><input type='submit' value='Delete' name='Delete' class='btn btn-danger btn-lg' />";
		...
		if($cookie == "Etapas"){ //SI LA COOKIE ES IGUAL A ETAPAS MOSTRARA LA SIGUIENTE TABLA
			$tabla .= 	"<h1>Etapa</h1><table class='table table-striped'><thead><tr><th>Nombre</th></tr></thead><tbody><tr><td><input type='text' name='nombre' value='' /></td></tr></tbody></table><input type='submit' value='Volver' name='Volver' class='btn btn-success btn-lg' /><input type='submit' value='Crear' name='Crear' class='btn btn-warning btn-lg' />";
		}elseif($cookie == "Clases"){ //SI LA COOKIE ES IGUAL A CLASES MOSTRARA LA SIGUIENTE TABLA
			...
			$tabla .= "</select></td></tr></tbody></table><input type='submit' value='Volver' name='Volver' class='btn btn-success btn-lg' /><input type='submit' value='Crear' name='Crear' class='btn btn-warning btn-lg' />";
		}elseif($cookie == "Alumnos"){ //SI LA COOKIE ES IGUAL A ALUMNOS MOSTRARA LA SIGUIENTE TABLA
